...
export default function CategoryProductsPage() {
  ...
  // Fetch category with React Query
  const { 
    data: category, 
            ...
            <div className="text-center py-16 bg-gray-50 rounded-lg border border-gray-100">
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-600 mb-8 max-w-md mx-auto">
                  Sorry, we couldn't find the requested category or there was an error loading products. Please try a different category or browse all products.
                </p>
                <Button 
                  variant="outline" 
                  className="rounded-full px-8 bg-black hover:bg-black/80 text-white hover:text-white border-black transition-colors" 
                  asChild
                >
                  <Link href="/products">
                    Back to Products
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            {isCategoryLoading ? (
              ...
              <p className="text-gray-600">{category?.description || 'Browse our products'}</p>
            )}
          </div>
