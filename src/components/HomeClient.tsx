...
export function HomeClient({ initialProducts }: HomeClientProps) {
  ...
  useEffect(() => {
    ...
    // Preconnect to external domains used for images
    const preconnectLinks = [
      { rel: 'preconnect', href: 'https://randomuser.me' }
    ];
  ...
  // Use server-provided initial products with React Query's hydration
  const { data: allProducts = initialProducts, isLoading: allProductsLoading, isError: allProductsError } = useQuery<Product[]>({
    queryKey: ['homeProducts', 'all'],
    initialData: initialProducts,
    staleTime: 1000 * 60 * 5, // Consider data fresh for 5 minutes
    refetchOnWindowFocus: false,
    queryFn: async () => {
      // Client-side fetch to get fresh products
      try {
        ...
        // If client-side fetch fails, return initialProducts so UI doesn't break
  ...
  const displayProducts = useMemo(() => {
    ...
    // Then get the rest, ensuring no duplicates
    ...
    console.log(`Combined products: ${combined.length}`);
    
    // Limit to exactly 8 products
    const finalProducts = combined.slice(0, 8);
                      ...
                      <div className="flex items-center">
                        <div className="w-10 h-10 rounded-lg overflow-hidden flex-shrink-0">
                          <Image 
                            ...
                            alt="Alex W. - Customer who uses Smart Pet Feeder" 
                            width={40} 
                            height={40} 
                      ...
                      <div className="flex items-center">
                        <div className="w-10 h-10 rounded-lg overflow-hidden flex-shrink-0">
                          <Image 
                            ...
                            alt="Sarah J. - Customer who uses GPS Smart Collar" 
                            width={40} 
                            height={40} 
                            className="w-full h-full object-cover"
                          />
                      ...
                      <div className="flex items-center">
                        <div className="w-10 h-10 rounded-lg overflow-hidden flex-shrink-0">
                          <Image 
                            ...
                            alt="Miguel R. - Customer who uses HD Pet Camera" 
                            width={40} 
                            height={40} 
                            className="w-full h-full object-cover"
                          />
                      ...
                      <div className="flex items-center">
                        <div className="w-10 h-10 rounded-lg overflow-hidden flex-shrink-0">
                          <Image 
                            ...
                            alt="Taylor K. - Customer who uses Smart Health Monitor" 
                            width={40} 
                            height={40} 
                            className="w-full h-full object-cover"
                          />
                      ...
                      <div className="flex items-center">
                        <div className="w-10 h-10 rounded-lg overflow-hidden flex-shrink-0">
                          <Image 
                            ...
                            alt="Priya N. - Customer who uses Smart Home App" 
                            width={40} 
                            height={40} 
                            className="w-full h-full object-cover"
                          />
                      ...
                      <div className="flex items-center">
                        <div className="w-10 h-10 rounded-lg overflow-hidden flex-shrink-0">
                          <Image 
                            ...
                            alt="James L. - Customer who uses Interactive Toy Ball" 
                            width={40} 
                            height={40} 
                            className="w-full h-full object-cover"
                          />
